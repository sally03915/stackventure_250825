...
# 🧩 Step 1: 핵심 개념
***리눅스 사용자 및 권한 관리***  
  → ***사용자 정보 확인***, ***사용자 추가/삭제***, ***권한 구조***, ***소유자 변경***, ***권한 변경***
...
--- <!-- _class: aqua -->
- ***whoami / id*** 는 사용자 정보를 확인
- ***adduser / deluser*** 는 사용자 관리
- ***passwd*** 는 비밀번호 설정
- ***ls -l*** 은 권한 구조 확인
- ***chown / chmod*** 는 소유자 및 권한 변경
- ***umask*** 는 기본 권한 설정값을 보여줌

--- <!-- _class: green -->
# 🧪 Step 3: 연습문제
--- <!-- _class: aqua -->
1. ***whoami*** 명령어는 어떤 정보를 보여주나요?
2. ***adduser sally*** 명령어는 어떤 작업을 하나요?
3. ***ls -l*** 명령어는 어떤 정보를 확인할 수 있나요?
4. ***chmod 755 hello.txt*** 는 어떤 권한을 설정하나요?

--- <!-- _class: red -->
# 🧪 Step 5: 기억 테스트
--- <!-- _class: aqua -->
- ***id*** 명령어는 어떤 정보를 포함하나요?
- ***passwd*** 명령어는 어떤 상황에서 사용하나요?
- ***chown*** 명령어는 어떤 변경을 하나요?
- ***chmod*** 명령어는 어떤 방식으로 권한을 설정하나요?
- ***umask*** 는 어떤 역할을 하나요?
