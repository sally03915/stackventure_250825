...
<!-- _class: cover-fullstack -->
<h4 style="color:#6C757D;">
  <span style="color:#ff7043; text-shadow: 0 0 6px rgba(255,112,67,0.6); font-weight:bold;">🚀</span>
  CodeCraft Series · Track 12
</h4>  
<h1 style="color:#ff7043;">Spring 실전 풀스택</h1>
<h3 style="color:#FFD700;">MyBatis · JPA · React · Security · REST</h3>

<!-- 현재 챕터 강조 -->
<div class="chapter-highlight">
  📍 <strong>현재 위치:</strong> Chapter 2 · <em>JPA와 MyBatis 통합 전략</em>
</div>

<blockquote>
  <span class="fragment" style="color:#343A40;">백엔드와 프론트엔드를 연결하는 통합형 웹 서비스 개발</span><br>
  <span class="fragment" style="color:#495057;">Spring 기반의 인증, 데이터 처리, UI까지 모두 담은 실습 중심 강의</span>
</blockquote>

---

<!-- _class: cover-fullstack -->
<h2 style="font-size:1.6em; color:#333;">목차 : Spring 실전 풀스택 트랙</h2>

<div class="track-outline">
  <span>▶ Chapter 1: 프로젝트 구조와 기술 스택 소개</span>
  <span class="current-chapter">✅▶ Chapter 2: JPA와 MyBatis 통합 전략</span>
  <span>▶ Chapter 3: Spring Security 인증 처리</span>
  <span>▶ Chapter 4: React 프론트엔드 연동</span>
  <span>▶ Chapter 5: RESTful API와 배포 실습</span>
</div>

<p style="margin-top:30px; font-size:0.95em; color:#888;">
  이 트랙은 Spring 기반의 풀스택 웹 서비스를 <br/> 백엔드부터 프론트엔드까지 통합적으로 구현하는 실습 중심 과정입니다.
</p>
