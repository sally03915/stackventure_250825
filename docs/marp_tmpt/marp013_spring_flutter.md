...
<!-- _class: cover-springflutter -->
<h4 style="color:#6C757D;">
  <span style="color:#00bcd4; text-shadow: 0 0 6px rgba(0,188,212,0.6); font-weight:bold;">🚀</span>
  CodeCraft Series · Track 14
</h4>  
<h1 style="color:#00bcd4;">Spring + Flutter</h1>  
<h3 style="color:#FFD700;">REST · JSON · UI · Mobile · Web</h3>

<!-- 현재 챕터 강조 -->
<div class="chapter-highlight">
  📍 <strong>현재 위치:</strong> Chapter 2 · <em>Flutter 프로젝트 구조와 위젯 이해</em>
</div>

<blockquote>
  <span class="fragment" style="color:#343A40;">백엔드와 모바일 프론트엔드를 연결하는 통합형 앱 개발</span><br>
  <span class="fragment" style="color:#495057;">Spring의 API와 Flutter의 UI를 활용한 크로스 플랫폼 실습</span>
</blockquote>

---

<!-- _class: cover-springflutter -->
<h2 style="font-size:1.6em; color:#333;">목차 : Spring + Flutter 트랙</h2>

<div class="track-outline">
  <span>▶ Chapter 1: Spring API 설계와 통신 구조</span>
  <span class="current-chapter">✅▶ Chapter 2: Flutter 프로젝트 구조와 위젯 이해</span>
  <span>▶ Chapter 3: JSON 데이터 처리와 화면 연동</span>
  <span>▶ Chapter 4: 사용자 인증과 보안 처리</span>
  <span>▶ Chapter 5: 모바일 앱 배포와 웹 연동</span>
</div>

<p style="margin-top:30px; font-size:0.95em; color:#888;">
  이 트랙은 Spring과 Flutter를 활용해  백엔드와 모바일 UI를 통합하는 크로스 플랫폼 앱 개발을 실습 중심으로 안내합니다.
</p>
