...
<!-- _class: cover-springjpa -->
<h4 style="color:#6C757D;">
  <span style="color:#00b09b; text-shadow: 0 0 6px rgba(0,176,155,0.6); font-weight:bold;">🚀</span>
  CodeCraft Series · Track 10
</h4>  
<h1 style="color:#00b09b;">Spring 통합 웹 개발</h1>  
<h3 style="color:#dce35b;">Security · JPA · Thymeleaf · MVC</h3>

<!-- 현재 챕터 강조 -->
<div class="chapter-highlight">
  📍 <strong>현재 위치:</strong> Chapter 2 · <em>JPA와 엔티티 매핑</em>
</div>

<blockquote>
  <span class="fragment" style="color:#343A40;">인증, 데이터, UI까지 하나로 연결하는 실전형 스프링 프로젝트</span><br>
  <span class="fragment" style="color:#495057;">Spring Boot 기반의 웹 서비스 구현을 위한 핵심 기술 총집합</span>
</blockquote>

---

<!-- _class: cover-springjpa -->
<h2 style="font-size:1.6em; color:#f0f0f0;">목차 : Spring 통합 웹 개발 트랙</h2>

<div class="track-outline">
  <span>▶ Chapter 1: Spring Boot 프로젝트 생성</span>
  <span class="current-chapter">✅▶ Chapter 2: JPA와 엔티티 매핑</span>
  <span>▶ Chapter 3: 인증과 보안 설정 (Spring Security)</span>
  <span>▶ Chapter 4: Thymeleaf 템플릿 처리</span>
  <span>▶ Chapter 5: MVC 구조와 실전 프로젝트</span>
</div>

<p style="margin-top:30px; font-size:0.95em; color:#ccc;">
  이 트랙은 Spring Boot 기반의 웹 서비스를 <br/> 인증, 데이터 처리, UI까지 통합적으로 구현하는 실습 중심 과정입니다.
</p>
