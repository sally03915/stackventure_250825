...
<h4 style="color:#f0f0f0;">
  ...
  CodeCraft Series · Track 05
</h4>

<h1 style="color:#ffffff;">Python + Django 실전 </h1>  
<h3 style="color:#cceeff;">백엔드 로직부터 웹 서비스 구축까지</h3>

<!-- 현재 챕터 강조 -->
<div class="chapter-highlight">
  📍 <strong>현재 위치:</strong> Chapter 2 · <em>Django 프로젝트 구조 이해</em>
</div>

<blockquote>
  <span class="fragment" style="color:#343A40;">파이썬의 유연함과 Django의 강력함을 결합한 웹 개발</span><br>
  <span class="fragment" style="color:#495057;">실전 프로젝트로 배우는 백엔드의 모든 것</span>
</blockquote>

---

<!-- _class: cover-python -->
<h2 style="font-size:1.6em; color:#f0f0f0;">목차 : Python + Django 실전 개발 트랙</h2>

<div class="track-outline">
  <span>▶ Chapter 1: Python 기초 문법과 함수</span>
  <span class="current-chapter">✅▶ Chapter 2: Django 프로젝트 구조 이해</span>
  <span>▶ Chapter 3: 모델과 ORM 활용</span>
  <span>▶ Chapter 4: 뷰와 템플릿 처리</span>
  <span>▶ Chapter 5: 배포와 운영 전략</span>
</div>

<p style="margin-top:30px; font-size:0.95em; color:#ccc;">
  이 트랙은 Python과 Django를 활용해 <br/> 실제 웹 서비스를 구축하는 과정을 단계별로 안내합니다.
</p>
