...
<h4 style="color:#6C757D;">
  <span style="color:#00CED1; text-shadow: 0 0 6px rgba(0,255,255,0.6); font-weight:bold;">🚀</span>
  CodeCraft Series · Track 07
</h4>  
<h1 style="color:#20B2AA;">ChatGPT API 활용</h1>  
<h3 style="color:#5F9EA0;">AI · REST · JSON · Prompt Engineering</h3>

<!-- 현재 챕터 강조 -->
<div class="chapter-highlight">
  📍 <strong>현재 위치:</strong> Chapter 2 · <em>OpenAI API 구조와 인증 방식</em>
</div>

<blockquote>
  <span class="fragment" style="color:#343A40;">AI와 웹을 연결하는 실전 API 활용법</span><br>
  <span class="fragment" style="color:#495057;">ChatGPT를 내 서비스에 통합하는 기술과 창의력의 만남</span>
</blockquote>

---

<!-- _class: cover-ai -->
<h2 style="font-size:1.6em; color:#f0f0f0;">목차 : ChatGPT API 활용 트랙</h2>

<div class="track-outline">
  <span>▶ Chapter 1: ChatGPT API 개요와 활용 사례</span>
  <span class="current-chapter">✅▶ Chapter 2: OpenAI API 구조와 인증 방식</span>
  <span>▶ Chapter 3: 프롬프트 설계와 응답 처리</span>
  <span>▶ Chapter 4: RESTful 통신과 JSON 파싱</span>
  <span>▶ Chapter 5: 실전 프로젝트 · AI 챗봇 만들기</span>
</div>

<p style="margin-top:30px; font-size:0.95em; color:#ccc;">
  이 트랙은 ChatGPT API를 활용하여 <br/> 실제 서비스에 AI를 통합하는 과정을 실습 중심으로 안내합니다.
</p>
