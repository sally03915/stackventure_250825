...
<div class="chapter-highlight">
  📍 <strong>현재 위치:</strong> Chapter 2 · <em>HTML 기본 구조와 시맨틱 태그</em>
</div>
...
<div class="track-outline">
  ...
  <span class="current-chapter">✅▶ Chapter 2: HTML 기본 구조와 시맨틱 태그</span>
  <span>▶ Chapter 3: CSS 스타일링과 레이아웃</span>
  <span>▶ Chapter 4: JavaScript 기초 문법</span>
  <span>▶ Chapter 5: jQuery와 Bootstrap 활용</span>
</div>
