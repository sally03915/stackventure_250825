...
<!-- _class: cover-jsp -->
<h2 style="font-size:1.6em; color:#555;">목차 : JSP Essentials 트랙</h2>

<div class="track-outline">
  <span>▶ Chapter 1: JSP 개요와 실행 흐름</span>
  <span class="current-chapter">✅▶ Chapter 2: JSP 페이지 구조와 지시자</span>
  <span>▶ Chapter 3: 내장 객체와 스크립틀릿</span>
  <span>▶ Chapter 4: 액션 태그와 표현 언어(EL)</span> 
</div>

<p style="margin-top:30px; font-size:0.95em; color:#888;">
  이 트랙은 JSP 기반의 웹 애플리케이션 개발을 <br/> 실습 중심으로 학습하며, 서버 사이드 기술의 기초를 다집니다.
</p>
